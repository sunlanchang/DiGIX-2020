...
online_train_model_input = {
    name: train_df[name].values for name in feature_names}
online_test_model_input = {
    name: test_df[name].values for name in feature_names}
# In[8]:


# train_test_reduced = reduce_mem(train_test)
# train_test_reduced.memory_usage().sum() / 1024**3
...
hist = model.fit(online_train_model_input, train_df['label'].values,
